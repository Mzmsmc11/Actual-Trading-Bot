"""
Listens for DMs sent to the bot and replies to commands. This runs
independently of the channel posting - it's how individual users get
...
from config import LAST_UPDATE_ID_FILE
...
START_TEXT = (
    ...
    "and you can also ask it for prices directly here.\n\n" + HELP_TEXT
)
...
def _handle_message(message: dict):
    ...
    if text.startswith("/start"):
        ...
        send_message(handle_price_query(query), chat_id=chat_id)
    # anything else: ignored


def run_command_loop():
    """Blocks forever, polling for and responding to incoming DMs."""
